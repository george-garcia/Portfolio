...
function ProjectsPage() {
    ...
    const cyberFortressIT = {
        ...
        siteLink: 'https://cyberfortressit.me',
        gitLink: 'https://github.com/george-garcia/tech-website-cluster',
        description: "CyberFortressIT is a Managed Technology Service Provider mock website. It offers 4 categories of technology solutions: Cloud, Data, Application, and Cyber. This page is designed to be a marketing website for a company that offers these solutions to its client."
    }
    const portfolio = {
        subheading: 'Single Page Application',
            ...
            <div className={"projects-container grid grid-2-cols"}>
                ...
                <div className={"projects-backEnd--container"}>
                    <div className="projects-backEnd">
                        ...
                        <p className={"projects-description mb-2"}>We can Create users and login
                            by <strong>POST</strong>ing to this route. Passwords are hashed before they are stored using
                            bcrypt, and Authentication is handled via JSON Webtokens.</p>

                        <p className="label">Tickets Route: /api/v1/tickets</p>
                        <p className={"projects-description mb-2"}>We can fetch multiple users or one users data
                            via <strong>GET</strong> requests. Update tickets with <strong>PATCH</strong>. Create
                            tickets with <strong>POST</strong>, and delete a ticket with <strong>DEL</strong>.
                        </p>

                        <p className="label">Users Route: /api/v1/users</p>
                        <p className={"projects-description mb-2"}>Retrieving our user data comes from the <strong>GET</strong> request. Updating
                            users can be done via <strong>PATCH</strong>. Then finally we can delete users with
                            a <strong>DEL</strong> request.</p>

                        <p className="label">Data Relationships:</p>
                        <p className={"projects-description mb-2"}>
                            <strong>One</strong> user may have <strong>many</strong> tickets assigned to them
                            while <strong>one</strong> ticket can only have <strong>one</strong> user.
                        </p>
                    </div>
